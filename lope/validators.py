...
# ─── EnsemblePool — re-exported from lope.ensemble (v0.5.0) ─────────────
#
# Moved to its own module so third-party consumers can import the parallel
# fan-out + majority-vote primitive without depending on the full zoo of
